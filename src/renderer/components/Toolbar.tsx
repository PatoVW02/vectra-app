...
export function Toolbar({ onSettingsOpen }: ToolbarProps) {
  return (
    <div
      className="shrink-0 px-4 pb-2 flex items-end justify-between"
    ...
    >
      ...
      <button
        ...
        className="w-6 h-6 mb-0.5 flex items-center justify-center rounded text-zinc-600 hover:text-zinc-300 hover:bg-white/5 transition-colors"
      >
